...
module.exports = class extends Language {
    ...
    constructor(...args) {
        ...
        this.language = {
            ...
            COMMAND_SUBSCRIBE_NO_ROLE: (user) => `I am sorry, dear ${user}, but this server does not have a configured announcement role.`,
            COMMAND_SUBSCRIBE_SUCCESS: (role) => `Successfully granted the role: **${role}**`,
            COMMAND_UNSUBSCRIBE_SUCCESS: (role) => `Successfully remove the role: **${role}**`,
            COMMAND_SUBSCRIBE_NO_CHANNEL: `I am sorry but this server does not have a configured announcement channel.`,
            COMMAND_ANNOUCEMENT: (role) => `**New announcement for** ${role}`,
            SYSTEM_HIGHEST_ROLE: `this role's hierarchy position is higher or equal to me, i am unable to grant it to anyone.`,
            ...
            COMMAND_BAN_HIGHEST_ROLE: `you may not execute this command on this user`,
            COMMAND_NOTBANABLE: `i am not able to ban/kick this member, sorry`
